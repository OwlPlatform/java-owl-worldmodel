...
/**
 * The first message sent across a World Model-Client connection.  The handshake is used to 
...
public class HandshakeMessage {
	 ...
	 */
	public static final String PROTOCOL_STRING = "GRAIL client protocol";
	...
	public String toString()
	{
		...
		sb.append("World Model Handshake (Client): ")
